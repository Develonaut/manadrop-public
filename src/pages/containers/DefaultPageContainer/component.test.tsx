...
import { DefaultPageContainer, PublicProps } from "./component";
...
describe("Collections", () => {
  test("should render with passed in children components", () => {
    ...
    expect(wrapper.find({ "data-test-selector": "main" })).toHaveLength(1);
    expect(wrapper.find({ "data-test-selector": "content" })).toHaveLength(1);
